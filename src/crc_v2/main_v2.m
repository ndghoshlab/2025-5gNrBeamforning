%%% main_v2.m does not work because of 'if' block inside of parfor,
...
pmiPrecoding = 1; % 0: SVD, 1: PMI, 2: s-PMI
    ...
    parfor iterIdx = 1:numIter
        ...
        for snrIdx = 1:numSNR
            ...
            if perfTx
                switch pmiPrecoding
                    case 0
                        precodingWeights = SVDPertfChan;
                    case 1 
                        precodingWeights = (pmiInfoPerfect_csirs.W).';
                    case 2
                ...
                switch pmiPrecoding
                    case 0
                        precodingWeights = SVDNotPerfChan;
                    case 1
                        precodingWeights = (pmiInfoPractical_csirs.W).';
                    case 2
                        precodingWeights = closestPMI.';
                end
            end
...
try
    save(saveFile, 'numIter', 'ModOrderList','pmiPrecoding', ...
        ...
        'Save_sPMI_all', 'SaveMetadata_all', ...
        '-v7.3');
...
%             'csirs','reportConfig','startTime','endTime', ...
%             'avgBER_all','totalSlotErrors_all','avgBitErrorsPerSlot_all','SNRdB_all','combinationLabels', ...
%             'SavePMIperfect_all','SavePMIpractical_all','SaveSVDperfect_all','SaveSVDpractical_all', 'Save_sPMI_all', 'SaveMetadata_all', ...
%             '-v7.3');
%         fprintf('Results saved to: %s\n', saveFile);
%     catch ME
%         fprintf('WARNING: Saving results failed: %s\n', ME.message);
...
%             'csirs','reportConfig','startTime','endTime', ...
%             'avgBER_all','totalSlotErrors_all','avgBitErrorsPerSlot_all','SNRdB_all','combinationLabels', ...
%             'SavePMIperfect_all','SavePMIpractical_all','SaveSVDperfect_all','SaveSVDpractical_all','SaveMetadata_all', ...
%             '-v7.3');
%         fprintf('Results saved to: %s\n', saveFile);
%     catch ME
%         fprintf('WARNING: Saving results failed: %s\n', ME.message);
