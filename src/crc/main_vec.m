...
saveFile = [sprintf('results_%s', datestr(startTime,'yyyymmdd_HHMMSS')) '_vec.mat'];
...
fprintf('SNR values (dB): %s\n', strjoin(string(SNRdB), ', '));
...
save(saveFile, 'noSlotsSim','ModOrderList', ...
        'perfectEstimation','numIter', ...
        ...
        'SVD_newPrecodingWeight', 'PMI_pmiInfoPractical', ...
        '-v7.3');
