...
%% ------------------------------------------------------------------------
% Combined Plot - Packet Errors vs SNR for All Combinations
% -------------------------------------------------------------------------
figure('Position', [100, 100, 900, 600]);
hold on;
grid on;
...
for combIdx = 1:numCombinations
    plot(SNRdB, totalPacketErrors_all(combIdx, :), ...
        'LineWidth', 2, ...
        'Marker', markers{combIdx}, ...
        'MarkerSize', 8, ...
        'Color', colors(combIdx, :), ...
...
hold off;
xlabel('SNR (dB)', 'FontSize', 12, 'FontWeight', 'bold'); 
ylabel('Total Packet Errors', 'FontSize', 12, 'FontWeight', 'bold'); 
title(sprintf('Packet Errors vs SNR Comparison (%d packets, %d slots/packet)', numIter, noSlotsSim), ...
    'FontSize', 14, 'FontWeight', 'bold');
legend('Location', 'best', 'FontSize', 10);
set(gca, 'FontSize', 11);

%% ------------------------------------------------------------------------
% Combined Plot - Average Bit Errors per Packet vs SNR
% -------------------------------------------------------------------------
figure('Position', [100, 100, 900, 600]);
hold on;
grid on;
...
for combIdx = 1:numCombinations
    semilogy(SNRdB, avgBitErrorsPerPacket_all(combIdx, :), ...
        'LineWidth', 2, ...
        'Marker', markers{combIdx}, ...
        'MarkerSize', 8, ...
        'Color', colors(combIdx, :), ...
...
hold off;
xlabel('SNR (dB)', 'FontSize', 12, 'FontWeight', 'bold'); 
ylabel('Average Bit Errors per Packet', 'FontSize', 12, 'FontWeight', 'bold'); 
