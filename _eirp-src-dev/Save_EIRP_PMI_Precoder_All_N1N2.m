...
%     'Spacing',[AnElementSpacing_V,AnElementSpacing_H,SubArraySpacing_V,SubArraySpacing_H],'EnablePanelSubarray',true);
% 
% AntArrayTx                 = phased.NRRectangularPanelArray('Size',[SubArraySize,ArraySize(1), ArraySize(2)],...
...
%% Get the PMI vector
Enr_AzEl_PMI_Lin      = zeros(181,361,2);
Enr_AzEl_SSB_PMI_Lin  = zeros(181,361,2);

parfor pmi = 1:ContTempPMI
%for pmi = 10
    ...
    % figure
    % pattern(AntArrayTx,prm.CenterFreq,-180:AzUpSam:180,-90:ElUpSam:90,'CoordinateSystem','polar','Type','powerdb','Weights',gNB_WT_AntArrayPanel.*PMI2AntEleMatrix,'Normalize',PatternNormalization);
    % figure
    % pattern(AntArrayTx,prm.CenterFreq,5,-90:ElUpSam:90,'CoordinateSystem','polar','Type','powerdb','Weights',gNB_WT_AntArrayPanel.*PMI2AntEleMatrix,'Normalize',PatternNormalization);
    % figure
    % pattern(AntArrayTx,prm.CenterFreq,10,-90:ElUpSam:90,'CoordinateSystem','polar','Type','powerdb','Weights',gNB_WT_AntArrayPanel.*PMI2AntEleMatrix,'Normalize',PatternNormalization);

    % figure
    % pattern(AntArrayTx,prm.CenterFreq,-180:AzUpSam:180,-90:ElUpSam:90,'CoordinateSystem','rectangular','Type','powerdb','Weights',gNB_WT_AntArrayPanel.*PMI2AntEleMatrix,'Normalize',PatternNormalization);
    % figure
    % pattern(AntArrayTx,prm.CenterFreq,5,-90:ElUpSam:90,'CoordinateSystem','rectangular','Type','powerdb','Weights',gNB_WT_AntArrayPanel.*PMI2AntEleMatrix,'Normalize',PatternNormalization);
    % figure
    % pattern(AntArrayTx,prm.CenterFreq,22,-90:ElUpSam:90,'CoordinateSystem','rectangular','Type','powerdb','Weights',gNB_WT_AntArrayPanel.*PMI2AntEleMatrix,'Normalize',PatternNormalization);
...
folderPath = ['C:\Users\armed\Desktop\Notre-Dame-University\5G-NR-MIMO-Project\Project-Simulator\MIMO-5G-NR-Working-Environment\FullLink\5GNRSimulator-EIRP\SaveIng'];
