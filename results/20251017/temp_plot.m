...
% % Load PMI results
% pmi_mod4 = load('simPMI_snrY_nslot2_mod4_niter250e2.mat');
% pmi_mod4 = mean(pmi_mod4.inter_snr);

pmi_mod16 = load('simPMI_snrY_nslot2_mod16_niter250e2.mat');
...
pmi_mod256 = load('simPMI_snrY_nslot2_mod256_niter250e2.mat');
pmi_mod256 = mean(pmi_mod256.inter_snr);

% % Load SVD results
% svd_mod4 = load('simSVD_snrY_nslot2_mod4_niter250e2.mat');
% svd_mod4 = mean(svd_mod4.inter_snr);

svd_mod16 = load('simSVD_snrY_nslot2_mod16_niter250e2.mat');
svd_mod16 = mean(svd_mod16.inter_snr);

svd_mod64 = load('simSVD_snrY_nslot2_mod64_niter250e2.mat');
svd_mod64 = mean(svd_mod64.inter_snr);

svd_mod256 = load('simSVD_snrY_nslot2_mod256_niter250e2.mat');
